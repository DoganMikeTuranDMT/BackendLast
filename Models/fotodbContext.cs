        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<EmpUser>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email)
                    .HasName("UQ__EMP_USER__161CF7243A41D350")
                    .IsUnique();

                entity.HasIndex(e => e.Username)
                    .HasName("UQ__EMP_USER__B15BE12ED557D4E1")
                    .IsUnique();
                ...
                entity.HasOne(d => d.Client)
                    ...
                    .HasConstraintName("FK__EMP_USER__CLIENT__0EF836A4");
            });
            ...
            modelBuilder.Entity<ImageTempPass>(entity =>
            {
                entity.HasKey(e => new { e.ImageLink, e.TempPasswordId, e.OriginalFileName })
                    .HasName("PK__IMAGE_TE__73FB8CD69F09054A");
                ...
                entity.HasOne(d => d.TempPassword)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__IMAGE_TEM__TEMP___14B10FFA");
            });
            ...
            modelBuilder.Entity<TempPass>(entity =>
            {
                ...
                entity.HasIndex(e => e.TempPassword)
                    .HasName("UQ__TEMP_PAS__C4333C6AAE37864C")
                    .IsUnique();
